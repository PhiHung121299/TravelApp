...
////                                    UserOject user = new UserOject(hoten, loai, ngaysinh, uri.toString());
////                                    root.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(user);
////                                }
////                            });
//                    uploader.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
//                        @Override
...
//                            DatabaseReference root = db.getReference("users");
//
//                            UserOject obj = new UserOject(hoten, loai, ngaysinh, uri.toString());
